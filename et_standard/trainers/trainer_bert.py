...
from entity_typing_framework.main_module.main_module import CrossDatasetMainModule, IncrementalMainModule
...
cli = MyLightningCLI(CrossDatasetMainModule, DatasetManager, save_config_overwrite=True)
# load best model
