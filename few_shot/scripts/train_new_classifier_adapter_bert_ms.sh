...
# prepare data yaml
DATA_CONFIG_TEMPLATE='configs/data/'$DATA_TGT'_bert_ms.yaml'
NEW_DATA_CONFIG_PATH='configs/data/generated_data_files/'$DATA_TGT'_k'$shots'_instance'$instance'_classifier_bert.yaml'
...
$CMD trainers/trainer_new_bert.py fit \
...
--model configs/model/new_classifier_bert.yaml \
